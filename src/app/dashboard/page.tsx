...
// Dynamically import ReminderNotifications to avoid SSR issues
const ReminderNotifications = dynamic(() => import("@/components/reminder-notifications").then(mod => ({ default: mod.ReminderNotifications })), {
  ssr: false,
});
