          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h5 className="text-white font-medium mb-1">Mobile Notification Alerts</h5>
                  <p className="text-purple-700 dark:text-purple-200/80 text-sm">
                    Enhanced notifications with sound and vibration for reminders
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-purple-600 dark:text-purple-200/70 text-xs">Play notification sounds for reminders</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-purple-600 dark:text-purple-200/70 text-xs">Vibrate phone when reminders arrive</p>
                  </div>
                  <button
              ...
              {/* Info about how to get best results */}
              <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-blue-300 dark:text-blue-200 text-xs font-medium mb-1">For Best Results</p>
                    <p className="text-blue-600 dark:text-blue-200/70 text-xs leading-relaxed">
                      Install WellnessPal as an app on your home screen for more reliable notifications. Browser notifications work best when the app is open or running in the background.
                    </p>
                  </div>
                </div>
              </div>
